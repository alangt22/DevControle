...
export function ModalTicket() {
  ...
  return (
    <div
      className="absolute bg-gray-900/80 w-full min-h-screen z-99"
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              className="bg-red-500 p-1 px-2 text-white rounded cursor-pointer hover:bg-red-900 duration-300"
